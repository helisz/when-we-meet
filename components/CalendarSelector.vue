<template>
  <div class="bg-gray-800 p-4 rounded-lg border border-gray-700">
    <div class="flex justify-between items-center mb-4">
      <button @click="prevMonth" class="p-1 hover:bg-gray-700 rounded text-gray-400 hover:text-white">
        <
      </button>
      <span class="font-bold text-white">{{ format(currentMonth, 'MMMM yyyy') }}</span>
      <button @click="nextMonth" class="p-1 hover:bg-gray-700 rounded text-gray-400 hover:text-white">
        >
      </button>
    </div>
    ...
    <div class="grid grid-cols-7 gap-1">
      <div
        ...
        :class="[
          ...
          !isSameMonth(day, currentMonth) ? 'text-gray-600' : 'text-gray-300 hover:bg-gray-700',
...
import { startOfMonth, endOfMonth, startOfWeek, endOfWeek, eachDayOfInterval, addMonths, subMonths, format, isSameMonth, isSameDay } from 'date-fns'
